   <!-- ===========================================================================================================================================                   -->
   <!-- Add subject modal -->
   <div id="add-subject-modal" tabindex="-1" aria-hidden="true"
       ...
       <div class="relative p-4 w-full max-w-md max-h-full">
           ...
           <div class="relative bg-white rounded-sm shadow dark:bg-gray-700">
               ...
               <!-- Modal body -->
               <form class="p-4 md:p-5" id="add-subject-form">

                   <!-- Hidden Grade Level Field -->
                   <input type="hidden" name="grade_level" id="grade_level" value="college">

                   <div class="mb-4">
                       <label for="subject_name"
                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subject
                           name</label>
                       <input type="subject_name" name="subject_name" id="subject_name"
