...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.querySelector('form').addEventListener('submit', async function (event) {
        ...
        try {
            const response = await fetch('../../api/admin/api_students_add_college.php', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                await showAlert('success', `Registration successful: ${result.message}`);
                event.target.reset();
            } else {
    ...
    document.getElementById("backToStudentPageButton").addEventListener("click", function(e){
