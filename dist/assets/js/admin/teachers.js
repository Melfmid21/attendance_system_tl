...
document.addEventListener("DOMContentLoaded", function () {
    ...
    .addEventListener("submit", async function (event) {
      ...
      try {
        const response = await fetch(
          "../../api/admin/create_teacher_account.php",
          {
            method: "POST",
            headers: {
  ...
  document.querySelectorAll(".showEditTeacherModal").forEach((button) => {
    button.addEventListener("click", function () {
      ...
      document.querySelector("#edit-middle-initial").value =
        originalValues.middle_initial;
  ...
  document
    ...
    .addEventListener("submit", async function (event) {
      ...
      const currentValues = {
        ...
        middle_initial: document
          .getElementById("edit-middle-initial")
      ...
      try {
        const response = await fetch(
          "../../api/admin/edit_teacher_account.php",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json"
